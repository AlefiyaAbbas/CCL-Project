...
var CLIENT_ID =
  "989183315576-hdbrbc8o96t93f9jpbep97ihjh6jj6oe.apps.googleusercontent.com"
var API_KEY = "AIzaSyBtoII7tsOwQqPo8-9OPJqME0QDhDIvCio"
var DISCOVERY_DOCS = [
...
function upload() {
  ...
  if (text.value != "") {
    ...
    var metadata = {
      ...
      name:
        twoWords + "-" + String(Math.random() * 10000).split(".")[0] + ".txt",
      mimeType: "plain/text",
